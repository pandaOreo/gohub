...
type SignupUsingPhoneRequest struct {
	...
	PasswordConfirmation string `json:"password_confirmation,omitempty" valid:"password_confirmation"`
}
...
func SignupUsingPhone(data interface{}, c *gin.Context) map[string][]string {
	...
	errs = validators.ValidatePasswordConfirm(_data.Password, _data.PasswordConfirmation, errs)
